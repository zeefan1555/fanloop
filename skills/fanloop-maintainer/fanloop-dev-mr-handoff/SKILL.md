...
1. 幂等更新 PR 描述，至少包含背景、问题、解法、影响范围、验证命令、ADR impact、human 验收结论和交付边界。
...
4. 在当前用户可见回复中明确交付 PR URL、source/base、final head 和 checks；只在这些事实完整一致时上报 `merge_request_handed_off=passed` 和 `handoff_record_written=handoff-record.md`。
