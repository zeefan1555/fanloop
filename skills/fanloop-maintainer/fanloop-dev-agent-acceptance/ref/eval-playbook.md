...
| Workflow 边界 | 2 | 新建 Requirement；按 Status 推进；Card Binding、Trace Integration、文档和远端 Trace Event 均可回读且同步成功；到合法 Human Step 停止；机器人未审批、未合并、未发布 |
...
- governance_failed：使用用户 token 或 `--as user`、错误 app/群、机器人越过 Human Step、HEAD 漂移，
