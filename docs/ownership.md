...
| Local build | `internal/{buildinfo,doctor,release}/`, `tools/release-manifest/`, `scripts/{build-local,install-local}.sh` | Matched source builds, directory installation, diagnosis and atomic current switching |
